    ...
    <div className="border border-gray-300 rounded-lg overflow-hidden bg-white">
      <div className={"border-b border-gray-300 p-4 flex flex-col gap-2  "} >
        <div className="flex items-center " >
          <input type="radio" id="cod" name="payment" checked={payment === "cod"} onChange={()=>setPayment("cod")} 
      ...
      <div className={"p-4 flex flex-col gap-2 "}  >
        <div className="flex items-center "  >
          <input type="radio" id="bank" name="payment" checked={payment === "bacs"} onChange={()=>setPayment("bacs")} 
            className="w-5 h-5 text-blue-600 cursor-pointer"/>
