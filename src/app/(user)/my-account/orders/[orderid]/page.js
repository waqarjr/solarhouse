          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-4">
            <div className=''>
              ...
              <p className="text-slate-600">
                ...
                <span className="font-semibold text-slate-900"> {data.date_created.split("T")[0]} {data.date_created.split("T")[1]}  </span> and is currently &nbsp;
              ...
              <div className="space-y-4 mb-6">
                ...
                <div className="flex justify-between text-slate-600">
                  ...
                  <div className="text-right">
                    <div className="font-semibold text-slate-900">Rs {data.shipping_total}</div>
                  </div>
                </div>
                ...
                <div className="pt-4 border-t border-slate-200">
                  <div className="flex justify-between text-lg">
                    ...
                    <span className="font-bold text-slate-900">Rs {data?.total}</span>
                  </div>
                </div>
              </div>
            </div>
