      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3 sm:gap-4 h-full">
        ...
        >
          ...
          <div className="absolute bottom-0 left-0 bg-white rounded-tr-3xl sm:rounded-tr-4xl px-4 sm:px-6 py-3 sm:py-4 z-10 group-hover:bg-blue-50 transition-all duration-300">
            <Link href="/product-category/solar-panels" className="px-4 sm:px-6 py-2 bg-blue-500 text-white hover:bg-gray-800 cursor-pointer rounded-2xl text-sm sm:text-base font-medium transition-all duration-300 hover:scale-105 active:scale-95">
              Solar Panels
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-rows-2 gap-3 sm:gap-4">
          ...
          <div className="grid grid-cols-2 gap-3 sm:gap-4">
            ...
            >
              ...
              <div className="absolute left-0 bottom-0 bg-white rounded-tr-3xl px-3 sm:px-4 py-2 sm:py-3 z-10 group-hover:bg-blue-50 transition-all duration-300">
                <Link href="/product-category/solar-inverter" className="px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-500 text-white hover:bg-gray-800 cursor-pointer rounded-2xl text-xs sm:text-sm font-medium transition-all duration-300 hover:scale-105 active:scale-95">
                  Solar Inverters
                </Link>
              </div>
            </div>
            ...
            >
              ...
              <div className="absolute left-0 bottom-0 bg-white rounded-tr-3xl px-3 sm:px-4 py-2 sm:py-3 z-10 group-hover:bg-blue-50 transition-all duration-300">
                <Link href="/product-category/va-protectors" className="px-3 sm:px-4 py-1.5 sm:py-2 bg-blue-500 text-white hover:bg-gray-800 cursor-pointer rounded-2xl text-xs sm:text-sm font-medium transition-all duration-300 hover:scale-105 active:scale-95">
                  VP Protectors
                </Link>
              </div>
            </div>
          ...
          >
            ...
            <div className="absolute left-0 bottom-0 bg-white rounded-tr-3xl sm:rounded-tr-4xl px-3 sm:px-4 py-2 sm:py-3 z-10 group-hover:bg-blue-50 transition-all duration-300">
              <Link href="/product-category/va-protectors" className="px-3 sm:px-5 py-1.5 sm:py-2 bg-blue-500 text-white hover:bg-gray-800 cursor-pointer rounded-2xl text-xs sm:text-sm font-medium transition-all duration-300 hover:scale-105 active:scale-95">
